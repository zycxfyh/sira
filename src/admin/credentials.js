module.exports = (client) => {
  ...
  return {
    ...
    deactivate(credentialId, type) {
      ...
      return client
        .put(
          `${baseUrl}${encodeURIComponent(type)}/${encodeURIComponent(credentialId)}/status`,
        )
        .send({ status: false })
        .then((res) => res.body);
    },
    ...
    addScope(credentialId, type, scope) {
      ...
      return client
        .put(
          `${baseUrl}${encodeURIComponent(type)}/${encodeURIComponent(credentialId)}/scopes/${scope}`,
        )
        .then((res) => res.body);
    },
    ...
    setScopes(credentialId, type, scopes) {
      ...
      return client
        .put(
          `${baseUrl}${encodeURIComponent(type)}/${encodeURIComponent(credentialId)}/scopes/`,
        )
        .send({ scopes })
        .then((res) => res.body);
    },
