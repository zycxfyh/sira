...
describe('eg users create', () => {
  ...
  it('creates a user from properties', done => {
    ...
    env.argv = program.parse(
      'users create -p "username=' + username + '" ' + '-p "firstname=La" -p "lastname=Deeda"'
    );
  });
  ...
  it('prints only the user id when using the --quiet flag', done => {
    ...
    env.argv = program.parse(
      'users create -p "username=' + username + '" ' + '-p "firstname=La" -p "lastname=Deeda" -q'
    );
  });
  ...
  it('prints an error on invalid property syntax', done => {
    ...
    env.argv = program.parse(
      'users create -p "username=" ' + '-p "firstname=La" -p "lastname=Deeda"'
    );
  });
});
