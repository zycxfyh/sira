...
describe('Access Token tests', () => {
  describe('Save, Find and Get Access Token tests', () => {
    ...
    it('should save an access token', done => {
      newToken = {
        consumerId: '1234',
        authType: 'oauth2',
      };
    ...
    it('should find an access token', done => {
      tokenService
        .find(newToken)
        .then(token => {
    ...
    it('should not create a new access token if one exists and is not expired', done => {
      tokenService
        .findOrSave(newToken)
        .then(token => {
          token.access_token.should.eql(accessTokenFromDb);
    ...
    it('should save an access token with scopes', done => {
      newTokenWithScopes = {
        consumerId: '1234',
        authType: 'oauth2',
    ...
    it('should find an access token with scopes', done => {
    ...
    it('should get an access token with scopes', done => {
      const tokenFields = [
        'id',
        'tokenDecrypted',
        'consumerId',
    ...
    it('should not create a new access token with scopes if one exists and is not expired', done => {
      tokenService
  ...
  describe('Archive Access Token tests', () => {
    ...
    it('should not get an expired access token if not using the includeExpired flag', done => {
      tokenService
        .get(expiredToken)
        .then(token => {
    ...
    it('should create a new access token if one is expired', done => {
      tokenService
        .findOrSave(newToken)
        .then(token => {
    ...
    it('should get an expired access token with includeExpired flag', done => {
      tokenService
  ...
  describe('Get Access Tokens By Consumer', () => {
    ...
    it('should get active access tokens by consumer', done => {
      tokenService
    ...
    it('should get active and expired access tokens by consumer if provided includeExpired flag', () => {
      return tokenService.getTokensByConsumer('1234', { includeExpired: true }).then(tokens => {
        should.exist(tokens);
...
describe('Refresh Token tests', () => {
  describe('Save, Find and Get Refresh Token tests', () => {
    ...
    it('should save a refresh token along with access token', done => {
      newToken = {
        consumerId: '1234',
        authType: 'oauth2',
      };
    ...
    it('should find a refresh token along with access token', done => {
      tokenService
    ...
    it("should get refresh token's original token Obj", done => {
      tokenService
    ...
    it('should not create a new refresh token if one exists and is not expired', done => {
      tokenService
    ...
    it('should save a refresh token with scopes, along with an access token', done => {
      newTokenWithScopes = {
        consumerId: '1234',
        authType: 'oauth2',
        scopes: ['scope1', 'scope2', 'scope3'],
    ...
    it('should find a refresh token with scopes', done => {
      // changing the order of scopes array
      newTokenWithScopes.scopes = ['scope3', 'scope2', 'scope1'];
    ...
    it('should get a refresh token with scopes', done => {
      const tokenFields = [
        'id',
        'tokenDecrypted',
        'consumerId',
    ...
    it('should not create a new refresh token with scopes if one exists and is not expired', done => {
      tokenService
  ...
  describe('Archive Refresh Token tests', () => {
    ...
    it('should save a refresh token', done => {
      newToken = {
        consumerId: '1234',
        authType: 'oauth2',
      };
    ...
    it('should not find an expired refresh token if not using the includeExpired flag', done => {
      tokenService
        .find(newToken, { includeRefreshToken: true })
        .then(token => {
    ...
    it('should create a new refresh token if one is expired', done => {
    ...
    it('should not create a new refresh token if one is not expired, even if the access token is expired', done => {
      tokenService
        .findOrSave(newToken, { includeRefreshToken: true })
        .then(token => {
    ...
    it('should create a new refresh token if one does not exist, even if the access token is exists', done => {
      const tokenObj = {
        consumerId: '555555',
        authType: 'oauth2',
      };
      ...
      tokenService
        ...
        .then(token => {
          ...
          tokenService.findOrSave(tokenObj, { includeRefreshToken: true }).then(token => {
    ...
    it('should find an expired refresh token with includeExpired flag', done => {
      tokenService
        .get(expiredToken.refresh_token, { includeExpired: true, type: 'refresh_token' })
        .then(token => {
          should.exist(token);
  ...
  describe('Get Refresh Tokens By Consumer', () => {
    ...
    it('should get active tokens by consumer', done => {
      tokenService
    ...
    it('should get active and expired tokens by consumer if provided includeExpired flag', done => {
      tokenService
        .getTokensByConsumer('1234', { includeExpired: true, type: 'refresh_token' })
        .then(tokens => {
          should.exist(tokens);
          tokens.length.should.eql(tokenObjs.length * 2);
          tokens.forEach(tokenObj => {
