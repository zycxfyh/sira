...
module.exports = async () => {
  ...
  try {
    ...
    const _mockServerProcess = execSync("node test/mock-ai-server.js", {
      detached: true,
      stdio: "ignore",
    });
    ...
    const _gatewayProcess = execSync(
      "cross-env EG_CONFIG_DIR=config EG_HTTP_PORT=3004 EG_ADMIN_PORT=3005 node src/index.js",
      {
        detached: true,
        stdio: "ignore",
      },
    ...
    return async () => {
      ...
      try {
        // 停止网关
        execSync('pkill -f "node src/index.js"', { stdio: "ignore" });
