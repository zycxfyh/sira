...
const aiTracing = require("../../../core/policies/ai-tracing");
...
describe("AI Tracing Policy", () => {
  ...
  describe("Distributed Tracing", () => {
    ...
    it("should propagate trace headers to downstream", (done) => {
      ...
      policy(req, res, () => {
        expect(res.setHeader.calledWith("x-trace-id", req.egContext.traceId)).to
          .be.true;
        expect(res.setHeader.calledWith("x-span-id", req.egContext.spanId)).to
          .be.true;
        done();
      });
    });
