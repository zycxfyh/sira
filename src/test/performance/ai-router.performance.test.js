...
describe('AI Router Policy - Performance Tests', () => {
  ...
  describe('Scalability Benchmarks', () => {
    ...
    it.each(benchmarks)('should scale efficiently - $name ($requests requests)', ({ name, requests }) => {
      const testRequests = testDataFactory.createBatch(requests, () => testDataFactory.createAIRequest())
      const startTime = performance.now()
  ...
  describe('Error Handling Performance', () => {
    it('should handle errors without performance degradation', () => {
      const normalRequests = testDataFactory.createBatch(500, () => testDataFactory.createAIRequest())
