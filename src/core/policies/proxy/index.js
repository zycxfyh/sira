  ...
  schema: {
    ...
    properties: {
      ...
      proxyUrl: {
        type: "string",
        description:
          "An intermediate HTTP Proxy where send the requests to instead of the service endpoint directly",
      },
      secure: {
        type: "boolean",
        default: true,
      ...
      serviceEndpoint: {
        type: "string",
        description:
          "The serviceEndpoint reference where to proxy the requests to",
      },
      stripPath: {
        type: "boolean",
        default: false,
        description:
          "Specifies whether you want to strip the apiEndpoint path from the final URL.",
      },
      strategy: {
        type: "string",
        enum: ["round-robin"],
        default: "round-robin",
        description:
          "Specifies how to balance the requests between multiple urls in the same service endpoint",
      },
      toProxy: {
        type: "boolean",
        default: false,
