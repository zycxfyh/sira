  ...
  schema: {
    ...
    properties: {
      ...
      secretOrPublicKeyFile: {
        type: "string",
        description:
          "The secret (symmetric) or PEM-encoded public key (asymmetric) file for verifying the token's signature.",
      ...
      jwtExtractor: {
        ...
        default: "authBearer",
        description:
          "The method to use to extract the JWT from the current HTTP Request",
      },
      jwtExtractorField: {
        type: "string",
      ...
      checkCredentialExistence: {
        ...
        default: true,
        description:
          "Value istructing the gateway whether verify the sub against the internal SOC",
      },
      algorithms: {
        type: "array",
        items: {
    ...
    oneOf: [
      ...
      { required: ["secretOrPublicKeyFile"] },
    ],
  },
};
