...
<!-- 技术栈徽章 -->
<p>
  <a href="https://github.com/zycxfyh/sira/actions"><img src="https://img.shields.io/github/actions/workflow/status/zycxfyh/sira/ci.yml?branch=main&style=for-the-badge&logo=github-actions" alt="CI/CD"/></a>
  <a href="https://codecov.io/gh/zycxfyh/sira"><img src="https://img.shields.io/codecov/c/github/zycxfyh/sira?style=for-the-badge&logo=codecov" alt="Coverage"/></a>
  <a href="https://github.com/zycxfyh/sira/releases"><img src="https://img.shields.io/github/v/release/zycxfyh/sira?style=for-the-badge&logo=github" alt="Version"/></a>
  <a href="https://github.com/zycxfyh/sira/blob/main/LICENSE"><img src="https://img.shields.io/github/license/zycxfyh/sira?style=for-the-badge&logo=apache" alt="License"/></a>
...
| <img src="https://img.shields.io/badge/Docker-20+-2496ED?style=flat&logo=docker" alt="Docker"/>    | `20.0.0+`   | 容器化部署 _(可选)_   |
...
| 🔧 **专业开发工具** | ESLint+Prettier+Artillery+Clinic.js | 🚀 现代化开发体验      |
| 📦 **智能包分析**   | Bundle Analyzer + 性能监控          | 📊 实时包大小优化      |
| 🚀 **性能测试工具** | Artillery+autocannon+Clinic.js      | ⚡ API性能保障         |

</div>

> 📚 **查看完整功能列表** → [更多特性详情](docs/README-AI.md)

> 🔧 **查看工具集成详情** → [高级工具集成指南](docs/tools-integration-guide.md)
