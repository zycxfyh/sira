    ...
    function handleCharacterCardUpload(event) {
        ...
        reader.onload = (e) => {
            try {
                ...
                if (typeof data === 'object' && data !== null && data.name && data.coreIdentity && Array.isArray(data.personality)) {
                    ...
                    throw new Error("JSON 文件格式不正确或缺少必要的字段 (name, coreIdentity, personality)。");
                }
            } catch (error) {
