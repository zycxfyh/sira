...
<template>
    <div id="world-hud" class="game-panel">
        ...
        <div class="panel-content">
          ...
          <div class="meta-actions" style="margin-top: auto; padding-top: 1rem; border-top: 1px solid var(--border-color);">
            <button class="button primary" style="width: 100%; box-sizing: border-box; margin-bottom: 10px;" @click="uiStore.showWeaverConsole">
              织世者控制台
            </button>
